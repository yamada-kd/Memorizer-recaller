...
def main():
    ...
    os.makedirs("experiment/survey/01/parameter/{}/E".format(maxDataSize),exist_ok=True)
    os.makedirs("experiment/survey/01/parameter/{}/D".format(maxDataSize),exist_ok=True)
    dataLength=16
...
#    @tf.function
    ...
    for epoch in range(1,MaxEpochSize+1):
        ...
        if epoch%10==0:
            ...
            if validAcc>0.8:
                checkpointE.save("experiment/survey/01/parameter/{}/E/model".format(maxDataSize))
                checkpointD.save("experiment/survey/01/parameter/{}/D/model".format(maxDataSize))
                np.save("experiment/survey/01/parameter/{}/middle".format(maxDataSize),trainm)
                exit()
